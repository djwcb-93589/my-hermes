...
from hermes.backends import UnsupportedBackendError, get_backend
...
from hermes.tool_declarations.file import TOOL_DECLARATIONS
...
def register(registry):
    """注册 File 的运行时 handler 和审批处理器。"""
    register_file_approval_handler()
    registry.register_declaration(TOOL_DECLARATIONS[0], handle_file)
