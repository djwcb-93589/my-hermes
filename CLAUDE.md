...
- The OpenAI client targets OpenRouter by default (`anthropic/claude-sonnet-4`), but any OpenAI-compatible endpoint works. Don't assume Anthropic SDK semantics.
