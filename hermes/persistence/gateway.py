...
from .database import DBError, LATEST_SCHEMA_VERSION, _cleanup_batch_limit, transaction


def _sync_gateway_file_delivery_terminal(*args, **kwargs):
    """延迟解析文件投递领域，避免模块加载时形成循环依赖。"""
    from .delivery import _sync_gateway_file_delivery_terminal as sync
