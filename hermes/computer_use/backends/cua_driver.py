"""基于 cua-driver 的 P4 只读观察 Backend。"""
...
class CuaDriverBackend(ComputerUseBackend):
    """将 cua-driver 的只读工具转换为 Computer Use 正式契约。"""
    ...
    def _list_apps(self) -> list[AppInfo]:
        ...
        raw_result = self._client.call_tool("list_apps", {})
    ...
    def _click(
        ...
        self._raise_action_unavailable(action)
    ...
    def _type_text(
        ...
        self._raise_action_unavailable(ComputerUseAction.TYPE)
    ...
    def _key(
        ...
        self._raise_action_unavailable(ComputerUseAction.KEY)
    ...
    def _focus_app(
        ...
        self._raise_action_unavailable(ComputerUseAction.FOCUS_APP)
    ...
    def _raise_action_unavailable(
        ...
        raise BackendUnavailableError(
            "This Computer Use action is not available in the P4 "
            "observation backend.",
            details={
                "reason": "action_not_available_in_p4",
                "action": action.value,
            },
        )
