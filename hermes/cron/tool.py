...
from hermes.tool_declarations.cron import TOOL_DECLARATIONS
...
def register(registry):
    """注册 Cron 的运行时 handler 和审批处理器。"""
    register_cron_approval_handler()
    registry.register_declaration(TOOL_DECLARATIONS[0], handle_cron_tool)
